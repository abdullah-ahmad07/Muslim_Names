...
class QuranicName extends StatefulWidget {
  const QuranicName({super.key});

  @override
  State<StatefulWidget> createState() {
    return _QuranicNameState();
  }
}

class _QuranicNameState extends State<QuranicName> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<NameProvider>(context, listen: false).fetchNames('Quranic');
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Quranic Names"),
        leading: IconButton(
          icon: const Icon(
