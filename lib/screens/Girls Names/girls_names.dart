...
class GirlsNames extends StatefulWidget {
  const GirlsNames({super.key});

  @override
  State<StatefulWidget> createState() {
    return _GirlsNamesState();
  }
}

class _GirlsNamesState extends State<GirlsNames> {
  final String _filterOption = 'Girls Names';
